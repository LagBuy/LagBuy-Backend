...
class FavouriteVendor(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            return success_response(None, "Vendor added to favorites successfully", status_code=201)
    ...
    def destroy(self, request, vendor_id, *args, **kwargs):
        ...
        try:
            ...
            return success_response(None, "Vendor removed from favorites successfully", status_code=204)
        except CustomUser.DoesNotExist:
            return error_response("Vendor not found", status_code=404)
